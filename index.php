...
<head>
  ...
  <!-- Linking Google fonts f
   or icons -->
   <link rel="icon" href="https://res.cloudinary.com/dgsafyset/image/upload/v1736181402/self_notes/xxnsudkwcgxupcf13cir.png">
  <link rel="stylesheet"
...
<div class="black_page animate__animated animate__fadeIn" style="display: none;">
  ...
  <a href="#evs">
    ...
    <a href="#bio">
      <div class="top-next-box"><span class="nav-icon material-symbols-rounded ll">science</span>
        <h4 class="top-next-h4" id="cc">BIOLOGY</h4>
      </div>
    </a>
    <a href="#phy">
  ...
  <div class="top-next-m">
    ...
    <div class="top-next-m-row">
      <a href="#bio">
        <nav class="top-next-m-col">
          <h4><i class="fa-solid fa-radiation"></i> <span id="c">BIOLOGY</span></h4>
        </nav>
      </a>
      <a href="#eng">
        <nav class="top-next-m-col">
      ...
      <div class="first-child">
        ...
        <div class="first-note-main">
          ...
          <div class="note-body">
            ...
            <div class="note-btn">
              <button class="note-btns" ch1_name="phy Electromagnetic_waves" ch2_name="phy Electromagnetic_theory" ch1_link="" ch2_link="soon">View <i
              class="fa-solid fa-arrow-right"></i></button>
              <button class="note-video" ch1_name="" ch2_name="" ch1_link="" ch2_link="">Watch <i
              class="fa-solid fa-play"></i></button>
              <a href="#"><button class="note-btns">Download <i class="fa-solid fa-down-long"></i></button></a>
      ...
      <div class="first-child">
        ...
        <div class="first-note-main">
          ...
          <div class="note-body">
            ...
            <div class="note-btn">
              <button class="note-btns" ch1_name="mp foundry" ch2_name="null" ch1_link="" ch2_link="">View <i
              class="fa-solid fa-arrow-right"></i></button>
              <button class="note-video" ch1_name="" ch2_name="" ch1_link="" ch2_link="">Watch <i
              class="fa-solid fa-play"></i></button>
              <a href="#"><button class="note-btns">Download <i class="fa-solid fa-down-long"></i></button></a>
          ...
          <div class="note-body">
            ...
            <div class="note-btn">
              <button class="note-btns" ch1_name="mp metal_working" ch2_name="null" ch1_link="" ch2_link="">View <i
                  class="fa-solid fa-arrow-right"></i></button>
              <button class="note-video" ch1_name="" ch2_name="" ch1_link="" ch2_link="">Watch <i
                  class="fa-solid fa-play"></i></button>
              <a href="#"><button class="note-btns">Download <i class="fa-solid fa-down-long"></i></button></a>
          ...
          <div class="note-body">
            ...
            <div class="note-btn">
              <button class="note-btns" ch1_name="mp unit_4" ch2_name="null" ch1_link="" ch2_link="">View <i
                  class="fa-solid fa-arrow-right"></i></button>
                  <button class="note-video" ch1_name="" ch2_name="" ch1_link="" ch2_link="">Watch <i
                  class="fa-solid fa-play"></i></button>
              <a href="#"><button class="note-btns">Download <i class="fa-solid fa-down-long"></i></button></a>
        ...
        <div class="first-note-main">
          <div class="note-syllabus">
            ...
            <div class="note-body">
              ...
              <div class="note-btn">
                <button class="note-btns" ch1_name="bio " ch2_name="bio" ch1_link="" ch2_link="">View <i
                class="fa-solid fa-arrow-right"></i></button>
                <button class="note-video" ch1_name="" ch2_name="" ch1_link="" ch2_link="">Watch <i
                class="fa-solid fa-play"></i></button>
                <a href="#"><button class="note-btns">Download <i class="fa-solid fa-down-long"></i></button></a>
